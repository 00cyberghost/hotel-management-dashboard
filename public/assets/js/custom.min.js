var innap = (function () {
                ...
                jQuery(".dz-theme-mode").on("click", function () {
                    jQuery(this).toggleClass("active"),
                        jQuery(this).hasClass("active")
                            ? (jQuery("body").attr("data-theme-version", "dark"), setCookie("version", "dark"), jQuery("#theme_version").val("dark"))
                            : (jQuery("body").attr("data-theme-version", "light"), setCookie("version", "light"), jQuery("#theme_version").val("light")),
    ...
    return {
        init: function () {
             i(), o(), s(), c(), l(), d(), r(), u(), h(), m(), f(), p(), v(), g(), b(), k(), C(), z(), x(), y(), w()
            //  ,E();
        },
        load: function () {
            n(), t();
