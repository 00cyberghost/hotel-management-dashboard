     ...
     <div className="container-fluid">
           ...
           <div className="card gradient-1 card-bx">
             <div className="card-body d-flex align-items-center">
               <div className="me-auto text-white">
                 ...
                 <span className="fs-18">Booked Rooms</span>
               </div>
           ...
           <div className="card gradient-2 card-bx">
             <div className="card-body d-flex align-items-center">
               <div className="me-auto text-white">
                 ...
                 <span className="fs-18">Vacant Rooms</span>
               </div>
               <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <div className="col-xl-3 col-sm-6">
           <div className="card gradient-3 card-bx">
             <div className="card-body d-flex align-items-center">
               <div className="me-auto text-white">
                 <h2 className="text-white">285</h2>
                 <span className="fs-18">Cancelled Booking</span>
               </div>
               <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path fillRule="evenodd" clipRule="evenodd" d="M36.25 9.66665V7.24998C36.25 5.91598 37.3327 4.83331 38.6667 4.83331C40.0007 4.83331 41.0833 5.91598 41.0833 7.24998V9.66665C46.4242 9.66665 50.75 13.9949 50.75 19.3333V43.5C50.75 48.8384 46.4242 53.1666 41.0833 53.1666C34.1741 53.1666 23.8283 53.1666 16.9167 53.1666C11.5782 53.1666 7.25 48.8384 7.25 43.5V19.3333C7.25 13.9949 11.5782 9.66665 16.9167 9.66665V7.24998C16.9167 5.91598 17.9993 4.83331 19.3333 4.83331C20.6673 4.83331 21.75 5.91598 21.75 7.24998V9.66665H36.25ZM45.9167 29H12.0833V43.5C12.0833 46.168 14.2487 48.3333 16.9167 48.3333H41.0833C43.7537 48.3333 45.9167 46.168 45.9167 43.5V29ZM33.5748 37.8329L36.9822 34.5172C37.9392 33.5868 39.469 33.6086 40.3994 34.5656C41.3298 35.5202 41.3081 37.0523 40.3535 37.9827L35.3848 42.8161C34.4955 43.6788 33.1011 43.732 32.1513 42.9393L29.4302 40.6677C28.4055 39.8146 28.2677 38.2896 29.1232 37.265C29.9763 36.2403 31.5012 36.1026 32.5259 36.9581L33.5748 37.8329ZM41.0833 14.5V16.9166C41.0833 18.2506 40.0007 19.3333 38.6667 19.3333C37.3327 19.3333 36.25 18.2506 36.25 16.9166V14.5H21.75V16.9166C21.75 18.2506 20.6673 19.3333 19.3333 19.3333C17.9993 19.3333 16.9167 18.2506 16.9167 16.9166V14.5C14.2487 14.5 12.0833 16.6629 12.0833 19.3333V24.1666H45.9167V19.3333C45.9167 16.6629 43.7537 14.5 41.0833 14.5Z" fill="white"/>
               </svg>
         ...
         <div className="col-xl-3 col-sm-6">
           <div className="card gradient-4 card-bx">
             <div className="card-body d-flex align-items-center">
               <div className="me-auto text-white">
                 <h2 className="text-white">285</h2>
                 <span className="fs-18">Earnings Today</span>
               </div>
               <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path fillRule="evenodd" clipRule="evenodd" d="M36.25 9.66665V7.24998C36.25 5.91598 37.3327 4.83331 38.6667 4.83331C40.0007 4.83331 41.0833 5.91598 41.0833 7.24998V9.66665C46.4242 9.66665 50.75 13.9949 50.75 19.3333V43.5C50.75 48.8384 46.4242 53.1666 41.0833 53.1666C34.1741 53.1666 23.8283 53.1666 16.9167 53.1666C11.5782 53.1666 7.25 48.8384 7.25 43.5V19.3333C7.25 13.9949 11.5782 9.66665 16.9167 9.66665V7.24998C16.9167 5.91598 17.9993 4.83331 19.3333 4.83331C20.6673 4.83331 21.75 5.91598 21.75 7.24998V9.66665H36.25ZM45.9167 29H12.0833V43.5C12.0833 46.168 14.2487 48.3333 16.9167 48.3333H41.0833C43.7537 48.3333 45.9167 46.168 45.9167 43.5V29ZM33.5748 37.8329L36.9822 34.5172C37.9392 33.5868 39.469 33.6086 40.3994 34.5656C41.3298 35.5202 41.3081 37.0523 40.3535 37.9827L35.3848 42.8161C34.4955 43.6788 33.1011 43.732 32.1513 42.9393L29.4302 40.6677C28.4055 39.8146 28.2677 38.2896 29.1232 37.265C29.9763 36.2403 31.5012 36.1026 32.5259 36.9581L33.5748 37.8329ZM41.0833 14.5V16.9166C41.0833 18.2506 40.0007 19.3333 38.6667 19.3333C37.3327 19.3333 36.25 18.2506 36.25 16.9166V14.5H21.75V16.9166C21.75 18.2506 20.6673 19.3333 19.3333 19.3333C17.9993 19.3333 16.9167 18.2506 16.9167 16.9166V14.5C14.2487 14.5 12.0833 16.6629 12.0833 19.3333V24.1666H45.9167V19.3333C45.9167 16.6629 43.7537 14.5 41.0833 14.5Z" fill="white"/>
               </svg>
       ...
       <div className="row">
             ...
             <div className="col-xl-12 col-sm-6">
               <div className="card text-center">
                 <div className="card-body">
                   <div id="radialChart" className="radialChart"></div>
                   <h2>785</h2>
               ...
               <div className="card">
                 ...
                 <div className="card-body">
                   <div className="progress mb-4" style={{height:'13px'}}>
                     <div className="progress-bar gradient-5 progress-animated" style={{width: '55%',height:'13px'}} role="progressbar">
                       <span className="sr-only">45% Complete</span>
                     </div>
                   </div>
                   <div className="progress mb-4" style={{height:'13px'}}>
                     <div className="progress-bar gradient-6 progress-animated" style={{width: '70%', height:'13px'}} role="progressbar">
                       <span className="sr-only">45% Complete</span>
                     </div>
                   </div>
                   <div className="progress default-progress" style={{height:'13px'}}>
                     <div className="progress-bar gradient-7 progress-animated" style={{width: '50%', height:'13px'}} role="progressbar">
                       <span className="sr-only">45% Complete</span>
                     </div>
                   </div>
         ...
         <div className="col-xl-6">
           <div className="card">
             <div className="card-body booking-calender  pb-0">
             ...
             <div className="card-body py-0">
               ...
               <div className="row">
                 <div className="col-xl-6 col-sm-6">
                   <div className="dz-image-bx rounded">
                     <div className="dz-media active me-3">
                       <img className="rounded" src="/assets/images/avatar/1.jpg" alt="" />
                     </div>
                 ...
                 <div className="col-xl-6 col-sm-6">
                   <div className="dz-image-bx rounded">
                     <div className="dz-media active me-3">
                       <img className="rounded" src="/assets/images/avatar/2.jpg" alt="" />
                     </div>
                     <div className="dz-info">
                 ...
                 <div className="col-xl-6 col-sm-6">
                   <div className="dz-image-bx rounded">
                     <div className="dz-media me-3">
                       <img className="rounded" src="/assets/images/avatar/3.jpg" alt="" />
                     </div>
                     <div className="dz-info">
                       <h5>Richard Smile</h5>
                       <span className="text-primary">October 3th, 2020</span>
                 ...
                 <div className="col-xl-6 col-sm-6">
                   <div className="dz-image-bx rounded">
                     <div className="dz-media me-3">
                       <img className="rounded" src="/assets/images/avatar/4.jpg" alt="" />
                     </div>
                     <div className="dz-info">
                       <h5>Bella Yen</h5>
                       <span className="text-primary">October 3th, 2020</span>
                 ...
                 <div className="card-body">
                   <div className="row">
                     ...
                     <div className="col-xl-6 d-flex align-items-center col-sm-6">
                       <div className="me-4">
                         <span className="donut" data-peity='{ "fill": ["#FFC368", "rgba(246, 246, 246)"],   "innerRadius": 45, "radius": 10}'>2/8</span>
                       </div>
                       <div>
                         <h2>30%</h2>
                         <span className="fs-18">Check Out</span>
               ...
               <div className="card">
                 ...
                 <div className="card-body customer-review-bx p-0 dz-scroll loadmore-content" id="customerReviewContent">
                   <div className="dz-review-bx">
                     <img className="dz-media me-4" src="/assets/images/avatar/1.jpg" alt="" />
                     <div className="dz-info">
                       <div className="dz-name mb-3">
                         <div>
                           <h6 className="title mb-1">Ali Muzair</h6>
                       ...
                       <div className="dz-footer">
                         ...
                         <a className="review-icon rounded-circle bg-success text-white me-3" href="#"><i className="far fa-check-circle"></i></a>
                         <a className="review-icon rounded-circle bg-danger text-white" href="#"><i className="far fa-times-circle"></i></a>
                       </div>
                     </div>
                   </div>
                   <div className="dz-review-bx">
                     <img className="dz-media me-4" src="/assets/images/avatar/2.jpg" alt="" />
                     <div className="dz-info">
                       <div className="dz-name mb-3">
                         <div>
                           <h6 className="title mb-1">Keanu Repes</h6>
                           <span className="date text-black op8">Posted on 26/04/2020, 12:42 AM</span>
                         </div>
                         <ul className="star-review">
                           <li><i className="fas fa-star orange"></i></li>
                   ...
                   <div className="dz-review-bx">
                     <img className="dz-media me-4" src="/assets/images/avatar/3.jpg" alt="" />
                     <div className="dz-info">
                       <div className="dz-name mb-3">
                         <div>
                           <h6 className="title mb-1">Chintya Clara</h6>
                           <span className="date text-black op8">Posted on 26/04/2020, 12:42 AM</span>
                         </div>
                         <ul className="star-review">
                           <li><i className="fas fa-star orange"></i></li>
                 ...
                 <div className="card-footer style-1 border-0 pt-0 text-center">
                   <a href="#" className="dz-load-more fas fa-chevron-down" id="customerReview" rel="/assets/ajax/customer-review.html"></a>
                 </div>
               </div>
             </div>
           </div>
