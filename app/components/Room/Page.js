                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                    <div className="d-flex">
                                                        <Link href="/admin/view_room" className="btn btn-primary shadow btn-xs sharp"><i className="fa fa-eye"></i></Link>
                                                        <Link href="/admin/edit_room" className="btn btn-danger shadow btn-xs sharp"><i className="fa fa-pencil"></i></Link>
